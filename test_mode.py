...
class TestMode:
    ...
    def get_tasks(self):
        ...
        return [
            ...
            },
            {
                ...
                'description': 'Make a fist to perform a right-click on the button below.',
                'instruction': 'Close your hand into a fist to right-click',
    ...
    def render_task3(self, parent, task):
        """Task 3: Right click"""
        label = tk.Label(parent, text="Make a fist to right-click the button:",
                        font=('Segoe UI', 14), bg='#0a1628', fg='#B0BEC5')
        label.pack(pady=50)
